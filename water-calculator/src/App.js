      ...
      component: (
        <>
          ...
          <Info
            color="blue"
            text="
              ⚠️ В момента водният калкулатор работи само за София-град. ⚠️
      ...
      component: (
        <>
          ...
          <Info
            color="blue"
            text="
              Душовете с водоспестяваща приставка намаляват разхода на вода, като същевременно осигуряват комфортен поток. 
              Те използват специална технология, която ограничава дебита, без да се губи ефективността на струята. 
              Такива душове са често срещани в съвременните домове и спомагат за по-икономично използване на водата.
            "
          />
        </>
      ),
      ...
      component: (
        <>
          ...
          <Info
            color="blue"
            text="
              Крановете в банята с водоспестяваща приставка намаляват разхода на вода, като същевременно осигуряват комфортен поток. 
              Те използват технология, която ограничава дебита, без да компрометира функционалността. 
              Такива кранове са често срещани в съвременните бани и спомагат за по-икономично използване на водата.
            "
          />
        </>
      ),
      ...
      component: (
        <>
          ...
          <Info
            color="blue"
            text="
              Кухненските кранове с водоспестяваща приставка намаляват разхода на вода, 
              като същевременно осигуряват ефективен поток за ежедневните нужди. Те използват технология, 
              която ограничава дебита, без да компрометира функционалността. Такива кранове са често срещани 
              в съвременните кухни и спомагат за по-икономично използване на водата.
            "
          />
        </>
      ),
        ...
        <>
          ...
          <Info
            ...
            text="
              ...
              За да изберете колко често поливате избраната от вас площ, 
              използвайте знаците + (плюс) и - (минус), за да регулирате честотата.
              За да изберете период, използвайте менюто и предложените опции.
              Ако сте си променили решението, можете винаги да го смените.
            "
